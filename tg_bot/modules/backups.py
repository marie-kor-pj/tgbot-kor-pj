...
def import_data(bot: Bot, update):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text("가져오기 전에 파일을 다운로드하여 자기것처럼 다시 업로드해 보세요 - 이 파일은 너무 많은 것 같아요!")
            return
...
__help__ = """
*관리자용 명령어*
 - /import: 그룹 버틀러 백업 파일에게 답장 처리된 메시지를 다른 곳으로 불러와요. 변환을 매우 쉽게 할 수 있는 기능이지만, \
 텔레그램 규칙에 따라 사진과 파일은 이 기능으로 옮길 수 없어요.
 - /export: !!! 아직 명령어는 아니지만 곧 출시될거예요.
"""
